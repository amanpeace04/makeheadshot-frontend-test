...
export default function AcademicsUseCase() {
  return (
    <div className="bg-white text-gray-900 leading-relaxed tracking-wide">
      ...
      <section className="px-6 py-24 md:px-16 lg:px-32 text-center bg-gradient-to-r from-corporate-blue/10 to-corporate-green/10">
        <h1 className="text-4xl md:text-5xl font-extrabold mb-6">
          AI Headshots for Academics & Educators
        </h1>
        <p className="text-lg md:text-xl max-w-3xl mx-auto text-gray-600 mb-8">
          Showcase your professional image for conferences, publications, and
          university profiles with polished AI-generated portraits.
        </p>
        <Link href="/user">
          <button className="bg-corporate-blue text-white px-8 py-4 rounded-full text-lg font-semibold shadow-md hover:bg-corporate-blue/90 transition duration-300">
            Generate Your Academic Headshot
          </button>
        </Link>
      </section>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-6xl mx-auto">
          {[
            ...
            >
              ...
              <Image
                src={img.ai}
                alt={`AI Academic Headshot ${i + 1}`}
                className="w-full object-cover transition-opacity duration-500"
                style={{ aspectRatio: "2 / 3" }}
              />
              <Image
                src={img.orig}
                alt={`Original Academic Photo ${i + 1}`}
      ...
      <section className="px-6 py-20 md:px-16 lg:px-32 space-y-24 max-w-7xl mx-auto">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="space-y-4">
            <h2 className="text-3xl font-bold">
              Build Credibility in Academia
            </h2>
            <p className="text-gray-600 text-lg">
              Present a confident, trustworthy image on your university profile,
              research papers, and speaking engagements.
            </p>
          </div>
          <Image
            src={ai2}
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-600 text-lg">
              Easily refresh your portraits to stay current with your evolving
      ...
      <section className="px-6 py-24 md:px-16 lg:px-32 text-center bg-gradient-to-br from-white via-corporate-blue/5 to-corporate-green/5">
        <h2 className="text-3xl md:text-4xl font-bold mb-4">
          Enhance Your Academic Presence with Professional Headshots
        </h2>
        <p className="text-lg text-gray-600 max-w-2xl mx-auto mb-8">
          AI-generated portraits help you convey professionalism and
          approachability in every academic setting.
        </p>
        <Link href="/user">
          <button className="bg-corporate-blue text-white px-8 py-4 rounded-full text-lg font-semibold shadow-md hover:bg-corporate-blue/90 transition duration-300">
            Get Started Now
